                                                                                ...
                                                                                <div class="crm-form">
                                                                                    ...
                                                                                    <div class="form-row">
                                                                                        ...
                                                                                        <div class="form-group col-md-12 col-12">
                                                                                            <label>Task Name<p>*</p></label>
                                                                                            <input type="text" class="form-control" placeholder="" name="" value="Send the student more information about the next steps for their visa" />
                                                                                        </div>

                                                                                        <div class="form-group col-md-6 col-12">
                                                                                        <label>Type</label>
                                                                                        <select class="form-control" name="cars" id="cars">
                                                                                            <option value="allstudent">Call</option>
                                                                                            <option value="europeans">Client Meeting</option>
                                                                                            <option value="allstudent">Event</option>
                                                                                            <option value="allstudent">Follow Up</option>
                                                                                            <option value="allstudent">Sales</option>
                                                                                            <option value="allstudent">test Message</option>
                                                                                        </select>
                                                                                        </div>    

                                                                                        <div class="form-group col-md-6 col-12">
                                                                                        <label>Due Date<p>*</p></label>
                                                                                        <input type="date" class="form-control" placeholder="" name="" value=""/>
                                                                                        </div>
                                                                                                        
                                                                                        <div class="form-group col-md-12 col-12">
                                                                                            <label>Task details (comments)<p>*</p></label>
                                                                                            <textarea name="message" rows="4" class="form-control" placeholder=""></textarea>
                                                                                        </div>
