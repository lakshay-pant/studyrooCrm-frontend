																															...
																															<div class="col-md-11">
																																<div class="main-timeline call">
																																	<div class="timeline active">
																																		...
																																		<button class="editleads-icon" onClick={showModal3}>
																																		    <i class="fa fa-ellipsis-h" aria-hidden="true"></i>		
																																		</button>
																																	    
																																		<div class="modal fade filters-modal show" id="leadsupdate" aria-modal="true">
																																			<Modal show={isOpen3} onHide={hideModal3}>
																																				<div id="leadsFilter" class="leadsedit">
																																					<div class="notes-area">
																																				<Modal.Body>
																																					<div class="fl-head">
																																					<h5> Edit activity</h5>
