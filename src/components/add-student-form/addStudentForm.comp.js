                                                        ...
                                                        <div class="col-md-12"> 
                                                          ...
                                                          <div class="col-md-12">
                                                           ...
                                                           <div class="col-md-12">
                                                                <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                                                                    <div class="card">
                                                                        <div class="card-header" role="tab" id="counseller">
                                                                          <a data-toggle="collapse" data-parent="#accordionEx" href="#counseller1" aria-expanded="true"
                                                                            aria-controls="counseller1">
                                                                            <div class="headingdiv">Counsellors<i class="fas fa-angle-down rotate-icon"></i></div>
                                                                          </a>
                                                                        </div>
                                                                        <div id="counseller1" class="collapse show" role="tabpanel" aria-labelledby="counseller"
                                                                            data-parent="#accordionEx">
                                                                            <div class="card-body">
                                                                            <div class="form-bgclr">
                                                                               <div class="form-row">
