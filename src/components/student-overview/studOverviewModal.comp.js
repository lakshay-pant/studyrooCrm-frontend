    ...
    <div class="modal-content">
        ...
        <div class="fotercontent">
            ...
            <div class="form-buttons-w">
                ...
                <button title="" type="button" class="btn float-right btn-primary getin-btn">
                   <span style="margin-left: 0px;">Save</span>
                </button>
            </div>
        </div>

        <div class="modal fade filters-modal" id="personalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
                ...
                <div class="modal-body">
                    <div class="student-filter-area">
                        <div class="row">
                              ...
                              <div class="counsellor">
                                  <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                                      <div class="card">
                                          ...
                                          <div id="collapseOne5" class="collapse show" role="tabpanel" aria-labelledby="headingOne2"
                                               data-parent="#accordionEx">
                                                <div class="card-body">
                                                    <div class="crm-form">
                                                      <div class="form-row">
                              ...
                              <div class="notes">
                                  <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                                      <div class="card">
                                          ...
                                          <div id="collapseOne6" class="collapse show" role="tabpanel" aria-labelledby="headingOne3"
                                               data-parent="#accordionEx">
                                                <div class="card-body">
                                                    <div class="crm-form">
                                                      <div class="form-row">
                          ...
                          <div class="col-lg-5 col-12">
                              <div class="personal">
                                      <div class="headingdiv">Personal Details</div>
