...
export const Application = () => {
	...
	const application = students.filter(function (student) {
		...
		<div class="col-md-4 col-12">
			<div class="data-block">
				<div class="data-heading">
					...
					<p>
						<span>{application.length} students</span>
					</p>
				</div>
				<div class="data-content">
					{application.length ? (
						application.reverse().map((row) => (
							<div class="data-con-box" key={row._id}>
								...
								<div class="post-time">
									<p>
										<i class="fas fa-calendar-alt"></i>Last Contacted 3 Days Ago
									</p>
								</div>
							</div>
						))
